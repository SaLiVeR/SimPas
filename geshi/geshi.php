...
class GeSHi {
     ...
     * @var string
     */
    var $overall_style = 'font-family:monospace; font-size: 13px; background: #fff; padding: 15px 15px 15px 20px; margin: 5px; border: 1px #DEDEDE solid;';
     ...
     * @var string
     */
    var $overall_class = 'img-rounded';

    /**
     * The overall ID for this code block
     * @var string
     */
    var $overall_id = '__content__';
